...
- Remote device (preferably Linux) with OpenSSH
...
- ufw: firewall
  ...
  - allow ssh access from LAN if needed: `sudo ufw allow from 192.168.0.0/24 to any port 22 proto tcp` (you may wish to change the SSH port to something other than 22)
- fail2ban: intrusion and brute-force attack prevention
- Tailscale: secure VPN for remote access
- OpenSSH: remote SSH access to server from a device of your choice
